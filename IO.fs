...
/// Common functions to set/query values of a VISA Agilent instrument.
...
module internal IO =
    ...
    /// Set a peak voltage value
    let setPeakVoltage = setValueString peakVoltageString
    /// Query a peak voltage value
