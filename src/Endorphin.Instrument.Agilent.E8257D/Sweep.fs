...
module Sweep =
    ...
    module Control =
        ...
        let internal setSweepOptions options instrument = async {
            ...
            do! setContinousMode options.Continuous instrument
        ...
        module List =
            ...
            let setDwellTimes key = IO.setSeq<Duration> dwellTimesKey key
            ...
            let setPowers key = IO.setSeq<Amplitude> powersKey key
            ...
            let setFrequencies key = IO.setSeq<Frequency> frequenciesKey key
    ...
    module Runtime =
        ...
        let initiate = fun x -> IO.post ":INIT" x
